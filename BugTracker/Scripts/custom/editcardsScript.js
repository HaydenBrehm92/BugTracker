$(document).ready(function () {
    $('#search').keyup(function () {
        ...
        bugcard = bugCat.getElementsByClassName("form-control")
        inProgressCat = document.getElementById('inprogresscontainer')
        progresscard = inProgressCat.getElementsByClassName("form-control");
        TestCat = document.getElementById('testingcontainer')
        testcard = TestCat.getElementsByClassName("form-control");
        CompletedCat = document.getElementById('completedcontainer')
        completecard = CompletedCat.getElementsByClassName("form-control");
